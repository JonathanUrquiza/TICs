...
<article class="card">
    ...
    <div class="card-materia">
        ...
        <div class="card-datos">
            <h4>Clase virtual:</h4>
            <a href="https://meet.google.com/uka-cnou-rfz"  class="btn btn-outline-secondary btnBuy">Meet</a>
...
function Thursday() {
    ...
    <div class="card-materia">
        ...
        <div class="card-datos">
            <h4>Clase virtual:</h4>
            <a href="https://meet.google.com/vqb-pyzg-ctv" class="btn btn-outline-secondary btnBuy">Meet</a>
...
function Friday() {
    ...
    <div class="card-materia">
        ...
        <div class="card-datos">
            <h4>Clase virtual:</h4>
            <a href="https://meet.google.com/nfj-dxyq-kax" class="btn btn-outline-secondary btnBuy">Meet</a>
